...
TWiki to elastyczna, potężna i łatwa w użyciu platforma do pracy
zespołowej. Jest to strukturalne Wiki, zwykle używane do prowadzenia
przestrzeni rozwojowej projektów, systemu zarządzania dokumentami,
bazy wiedzy i innych narzędzi pracy grupowej w intranecie lub
Internecie. Treść WWW może być tworzona wspólnie przy użyciu samej
przeglądarki. Deweloperzy mogą tworzyć nowe aplikacje WWW w opaciu o
API wtyczek.
